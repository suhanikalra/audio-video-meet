...
document.getElementById('talkbox-btn').addEventListener('click', function () {
    if (document.getElementById('talkbox').style.display == "none") {
...
document.getElementById('close-talkdiv').addEventListener('click', function () {
    document.getElementById('talkbox').style.display = "none";
})
